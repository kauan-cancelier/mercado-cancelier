...
import br.com.mercadocancelier.views.components.Aviso;
...
public class TelaDeVenda extends JFrame {
	...
	public TelaDeVenda() {
		...
		addWindowListener(new WindowAdapter() {
			...
			public void windowClosing(WindowEvent e) {
				int op = JOptionPane.showConfirmDialog(contentPane, "Você tem certeza que deseja sair? nenhum dado será salvo. ", "Aviso!!", JOptionPane.YES_NO_OPTION);
		...
		panelCodigo.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0)), "C\u00F3digo", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(51, 51, 51)));

		JPanel panelNomeDoProduto = new JPanel();
		panelNomeDoProduto.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0)), "Nome do produto", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		gl_panelNomeDoProduto.setHorizontalGroup(
			gl_panelNomeDoProduto.createParallelGroup(Alignment.LEADING)
				.addGroup(Alignment.TRAILING, gl_panelNomeDoProduto.createSequentialGroup()
					.addContainerGap()
		...
		panelValorCodigo.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0)), "Valor unit\u00E1rio", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		gl_panelValorCodigo.setHorizontalGroup(
			gl_panelValorCodigo.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panelValorCodigo.createSequentialGroup()
					.addContainerGap()
		...
		gl_panelValorCodigo.setVerticalGroup(
			gl_panelValorCodigo.createParallelGroup(Alignment.LEADING)
				.addGroup(Alignment.TRAILING, gl_panelValorCodigo.createSequentialGroup()
					.addContainerGap()
		...
		panelTotalDoItem.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0)), "Total do item", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(51, 51, 51)));
		...
		gl_panelTotalDoItem.setHorizontalGroup(
			gl_panelTotalDoItem.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panelTotalDoItem.createSequentialGroup()
					.addContainerGap()
		...
		gl_panelTotalDoItem.setVerticalGroup(
			gl_panelTotalDoItem.createParallelGroup(Alignment.LEADING)
				.addGroup(Alignment.TRAILING, gl_panelTotalDoItem.createSequentialGroup()
					.addContainerGap()
		...
		panelMeioDePagamento.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0)), "Forma de pagamento", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		gl_panelMeioDePagamento.setHorizontalGroup(
			gl_panelMeioDePagamento.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panelMeioDePagamento.createSequentialGroup()
					.addContainerGap()
					.addComponent(cbxFormaDePagamento, 0, 373, Short.MAX_VALUE)
					.addContainerGap())
		);
		gl_panelMeioDePagamento.setVerticalGroup(
			gl_panelMeioDePagamento.createParallelGroup(Alignment.LEADING)
		...
		panelSubTotal.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0)), "Subtotal", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		panel.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0)), "A\u00E7\u00F5es", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(255, 255, 255)));
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_contentPane.createSequentialGroup()
							.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING, false)
								.addComponent(panelCodigo, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
								.addComponent(panelNomeDoProduto, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
								.addComponent(panelValorCodigo, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
								.addComponent(panelTotalDoItem, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
							...
							.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING, false)
								...
								.addGroup(gl_contentPane.createSequentialGroup()
									.addComponent(panelTotalRecebido, GroupLayout.PREFERRED_SIZE, 441, GroupLayout.PREFERRED_SIZE)
									.addGap(18)
									.addComponent(panelTroco, GroupLayout.PREFERRED_SIZE, 441, GroupLayout.PREFERRED_SIZE))
		...
		gl_contentPane.setVerticalGroup(
			gl_contentPane.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGap(31)
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						.addComponent(panelSubTotal, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
				...
				btnSalvar.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						if (itensVenda.isEmpty()) {
							aviso.abrirTela("Nenhum produto adicionado a venda. ");
						} else {
							salvar();
		...
		gl_panelTroco.setHorizontalGroup(
			gl_panelTroco.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panelTroco.createSequentialGroup()
					.addContainerGap()
					.addComponent(labelTroco, GroupLayout.DEFAULT_SIZE, 419, Short.MAX_VALUE)
					.addContainerGap())
		);
		gl_panelTroco.setVerticalGroup(
			gl_panelTroco.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panelTroco.createSequentialGroup()
					.addComponent(labelTroco, GroupLayout.DEFAULT_SIZE, 36, Short.MAX_VALUE)
					.addContainerGap())
		);
		...
		gl_panelSubTotal.setHorizontalGroup(
			gl_panelSubTotal.createParallelGroup(Alignment.LEADING)
				.addGroup(Alignment.TRAILING, gl_panelSubTotal.createSequentialGroup()
					.addContainerGap()
					.addComponent(labelSubtotal, GroupLayout.DEFAULT_SIZE, 876, Short.MAX_VALUE)
					.addContainerGap())
		);
		gl_panelSubTotal.setVerticalGroup(
			gl_panelSubTotal.createParallelGroup(Alignment.LEADING)
				.addGroup(Alignment.TRAILING, gl_panelSubTotal.createSequentialGroup()
					.addContainerGap()
		...
		gl_panelCodigo.setHorizontalGroup(
			gl_panelCodigo.createParallelGroup(Alignment.TRAILING)
				.addGroup(Alignment.LEADING, gl_panelCodigo.createSequentialGroup()
					.addContainerGap()
		...
		gl_panelCodigo.setVerticalGroup(
			gl_panelCodigo.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panelCodigo.createSequentialGroup()
					.addContainerGap()
	...
	private void adicionarItemVenda() {
		if (txtCodigo.getText().length() >= 3) {
			try {
				...
				if (produto == null) {
					JOptionPane.showMessageDialog(contentPane, "Nenhum produto encontrado para esse código.", "Aviso!",
					...
					for (ItemVenda item : itensVenda) {
						if (item.getProduto().equals(produto)) {
							...
							BigDecimal precoTotal = BigDecimal
									.valueOf(produto.getPreco().doubleValue() * item.getQuantidade());
	...
	private void setLabels(ItemVenda itemVenda) {
		if (itemVenda != null) {
			...
			labelValorUnitario.setText("R$ " + ConverteNumero.numeroParaString(itemVenda.getProduto().getPreco().doubleValue()));
			labelTotalDoItem.setText("R$ " + ConverteNumero.numeroParaString(itemVenda.getPrecoTotal().doubleValue()));
			labelSubtotal.setText("R$ " + ConverteNumero.numeroParaString(calcularValorTotal().doubleValue()));			
		} else {
			labelNomeDoProduto.setText("");
			labelValorUnitario.setText("R$ ");
			labelTotalDoItem.setText("R$ ");
			labelSubtotal.setText("R$ " + ConverteNumero.numeroParaString(calcularValorTotal().doubleValue()));	
		}
	}
	...
	private void exibirTroco() {
		labelTroco.setText("R$ " + calcularTroco().toString());
	}

	private BigDecimal calcularTroco() {
		Double total = ConverteNumero.stringParaNumero(txtTotalRecebido.getText());
	...
	private void processarRemocaoItem(ItemVenda itemSelecionado) {
	    if (itemSelecionado.getQuantidade() > 1) {
	        ...
	        JOptionPane.showMessageDialog(contentPane, "Item removido.");
	    }
	...
	private void processarRemocaoItemQuantidadeMaiorQueUm(ItemVenda itemSelecionado) {
	    int qtdeParaRemover = obterQuantidadeRemover(itemSelecionado);

	    if (qtdeParaRemover > 0) {
	        itemSelecionado.setQuantidade(itemSelecionado.getQuantidade() - qtdeParaRemover);
	...
	private int obterQuantidadeRemover(ItemVenda itemSelecionado) {
	    ...
	    if (qtdeParaRemover > itemSelecionado.getQuantidade()) {
			aviso.abrirTela("A quantidade de itens para remoção é maior do que a quantidade de itens do produto. ");
	        return 0;
	    }
	    return qtdeParaRemover;
	}

	private BigDecimal calcularNovoPreco(ItemVenda itemSelecionado) {
	    return itemSelecionado.getProduto().getPreco()
	            .multiply(BigDecimal.valueOf(itemSelecionado.getQuantidade()));
	}

	private void exibirMensagemRemocao(ItemVenda itemSelecionado, int qtdeParaRemover) {
		aviso.abrirTela(qtdeParaRemover + " unidade(s) do produto: " + itemSelecionado.getProduto().getNome() + " foram removidas");
	}
